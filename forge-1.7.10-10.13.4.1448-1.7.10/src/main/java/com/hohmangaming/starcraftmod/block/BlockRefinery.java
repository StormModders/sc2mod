...
public class BlockRefinery extends Block
{
	...
	{
		super(Ids.BLOCKID_REFINERY, Material.rock);
		this.setHardness(1.0F);
		this.setStepSound(Block.soundMetalFootstep);
		this.setTextureName(StarcraftMod.ASSET_PREFIX + "refinery");
	...
	{
		this.iconFront = par1IconRegister.registerIcon(StarcraftMod.ASSET_PREFIX + "refinery_front");
		this.iconBack = par1IconRegister.registerIcon(StarcraftMod.ASSET_PREFIX + "refinery_back");
		this.iconTop = par1IconRegister.registerIcon(StarcraftMod.ASSET_PREFIX + "refinery_top");
		this.iconSide = par1IconRegister.registerIcon(StarcraftMod.ASSET_PREFIX + "refinery_side");
	}
//
//	@Override
//	@SideOnly(Side.CLIENT)
